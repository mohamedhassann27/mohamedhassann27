<h1 align="center">Hi , I'm Mohamed Hassan <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35"></h1>
<p align="center">
  <a href="https://github.com/DenverCoder1/readme-typing-svg"><img src="https://readme-typing-svg.herokuapp.com?font=Time+New+Roman&color=%23C8BE25&size=25&center=true&vCenter=true&width=600&height=100&lines=Software+Engineer;Front-end+Developer;Computer+Science+Student;Competitive+Programmer;"></a>
</p>
...
- 🏫 I am a second-year Computer Science student at Zagazig University.
- 💻 Front-end Developer & Software Engineer.
- 🧑‍💻 Skilled in React, JavaScript, Tailwind, CSS, HTML, C++, and Python.
- 🚀 Passionate about building modern, responsive, and high-performance web applications.
- 🏆 Competitive programmer with a strong background in Data Structures & Algorithms (C++).
- 📚 Always learning new technologies and improving my problem-solving skills.
- 🌍 Core Team Member at GDG (Google Developer Groups).
- 🔍 Open to new freelance opportunities—let’s create something amazing!
- 💡 Check out my portfolio: [https://www.linkedin.com/in/mohamed-hassan-986837294/]
- 📩 Contact me: [mohamedhassann542@gmail.com]
<br>
